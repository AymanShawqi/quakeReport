           ...
           JSONObject root=new JSONObject(SAMPLE_JSON_RESPONSE);
            ...
            for(int i=0;i<features.length();i++){
               JSONObject feature= features.getJSONObject(i);
                ...
                earthquake=new Earthquake(mag,place,time,url);
